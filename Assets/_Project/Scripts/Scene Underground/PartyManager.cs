...
namespace Descending.Scene_Underground
{
    public class PartyManager : MonoBehaviour
    {
        ...
        [SerializeField] private Dungeons.PartySpawner _spawner = null;
        ...
        public void OnRegisterPartySpawner(GameObject spawnerObject)
        {
            _spawner = spawnerObject.GetComponent<Dungeons.PartySpawner>();
        }
    }
}